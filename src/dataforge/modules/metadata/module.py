"""Metadata module implementation (skeleton)."""
...
class MetadataModule:
    ...
    async def health(self) -> list[DependencyHealth]:
        # TODO: probe Postgres connectivity once the engine is wired.
        return [DependencyHealth(name="metadata", status=HealthStatus.OK)]
